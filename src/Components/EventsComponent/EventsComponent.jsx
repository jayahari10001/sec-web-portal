...
import eventImage1 from '../../assets/Images/img_2.jpg'; // Adjust the path to your image
import eventImage2 from '../../assets/Images/img_3.jpg'; // Adjust the path to your image
import eventImage3 from '../../assets/Images/img_4.jpg'; // Adjust the path to your image
